...
define('MENUS_HOME', 'Головна');
define('MENUS_ADMIN', 'Адміністрування');
define('MENUS_ACCOUNT', 'Обліковий запис');
define('MENUS_ACCOUNT_EDIT', 'Редагувати обліковий запис');
define('MENUS_ACCOUNT_LOGIN', 'Вхід');
define('MENUS_ACCOUNT_LOGOUT', 'Вихід');
define('MENUS_ACCOUNT_REGISTER', 'Реєстрація');
define('MENUS_ACCOUNT_MESSAGES', 'Повідомлення');
define('MENUS_ACCOUNT_NOTIFICATIONS', 'Сповіщення');
define('MENUS_ACCOUNT_TOOLBAR', 'Панель інструментів');
