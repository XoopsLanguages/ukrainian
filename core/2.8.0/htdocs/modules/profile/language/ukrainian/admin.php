...
//XOOPS 2.5.9
define('_PROFILE_AM_CANNOTDEACTIVATEWEBMASTERS', 'Неможливо деактивувати обліковий запис Webmaster');
//XOOPS 2.5.11
define('_PROFILE_AM_EDIT_OPTION_STRINGS', 'Редагувати рядки параметрів');

// 2.7.4
define('_PROFILE_AM_DELETE_FAILED', 'Не вдалося видалити %s; обліковий запис не було видалено');
